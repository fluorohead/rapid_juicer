...
Обратите внимание, что это именно одна звёздочка, а не " \*.\* ", т.к. в последнем случае будут учитываться только файлы с расширениями. Но файлы могут и не иметь расширений, поэтому правильнее использовать " \* " .
